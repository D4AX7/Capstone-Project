...
public class DataSeeder
{
    ...
    private async Task SeedUtilityTypesAsync()
    {
        ...
        var utilityTypes = new List<UtilityType>
        {
            ...
            new()
            {
                ...
                UnitOfMeasurement = "Cubic Metres",
                IsActive = true,
                CreatedAt = now,
            },
            new()
    ...
    private async Task SeedTariffPlansAsync()
    {
        ...
        var tariffPlans = new List<TariffPlan>
        {
            new()
            {
                ...
                UtilityTypeId = 1,
                RatePerUnit = 6.50m,
                FixedCharges = 100.00m,
                TaxPercentage = 18.00m,
                LatePaymentPenalty = 100.00m,
                IsActive = true,
            ...
            new()
            {
                ...
                UtilityTypeId = 1,
                RatePerUnit = 8.50m,
                FixedCharges = 250.00m,
                TaxPercentage = 18.00m,
                LatePaymentPenalty = 250.00m,
                IsActive = true,
                EffectiveFrom = new DateTime(2024, 1, 1),
                CreatedAt = now,
            },
    ...
    private async Task SeedConsumersAsync()
    {
        ...
        // Get consumer users
        var rahul = await _userManager.FindByEmailAsync("rahul.verma@gmail.com");
        var sneha = await _userManager.FindByEmailAsync("sneha.patel@gmail.com");
        var vikram = await _userManager.FindByEmailAsync("vikram.mehta@gmail.com");
        var anita = await _userManager.FindByEmailAsync("anita.reddy@gmail.com");
        var suresh = await _userManager.FindByEmailAsync("suresh.gupta@gmail.com");
        ...
        if (suresh != null)
        {
            consumers.Add(
                new Consumer
                {
                    ...
                    Address = "56, Salt Lake City, Sector V",
                    City = "Kolkata",
                    State = "West Bengal",
                    PostalCode = "700091",
    ...
    private async Task SeedConnectionsAsync()
    {
        ...
        // Consumer 1 (Rahul) - Electricity and Water
        ...
        if (consumer1 != null)
        {
            connections.Add(
                new Connection
                {
                    ...
                    LoadSanctioned = 5.0m,
                    InstallationAddress = "42, MG Road, Koramangala, Bengaluru, Karnataka 560034",
                    CreatedAt = now,
                }
            );
            connections.Add(
        ...
        // Consumer 2 (Sneha) - Electricity and Gas
        ...
        if (consumer2 != null)
        {
            connections.Add(
                new Connection
                {
                    ...
                    LoadSanctioned = 7.0m,
                    InstallationAddress =
                        "15, Linking Road, Bandra West, Mumbai, Maharashtra 400050",
                    CreatedAt = now,
                }
            );
            connections.Add(
        ...
        // Consumer 3 (Vikram) - Commercial Electricity
        ...
        if (consumer3 != null)
        {
            connections.Add(
                new Connection
                {
                    ...
                    InstallationAddress = "78, Connaught Place, New Delhi, Delhi 110001",
                    CreatedAt = now,
                }
            );
        }

        // Consumer 4 (Anita) - Electricity and Internet
        ...
        if (consumer4 != null)
        {
            connections.Add(
                new Connection
                {
                    ...
                    Status = ConnectionStatus.Active,
                    LoadSanctioned = 5.0m,
                    InstallationAddress = "23, Anna Nagar East, Chennai, Tamil Nadu 600102",
                    CreatedAt = now,
                }
            );
            connections.Add(
        ...
        // Consumer 5 (Suresh) - Inactive Electricity and Active Water
        ...
        if (consumer5 != null)
        {
            connections.Add(
                new Connection
                {
                    ...
                    LoadSanctioned = 5.0m,
                    InstallationAddress =
                        "56, Salt Lake City, Sector V, Kolkata, West Bengal 700091",
                    CreatedAt = now,
                }
            );
            connections.Add(
    ...
    private async Task SeedBillingCycleAsync()
    {
        ...
        // Create billing cycles from January 2025 to current month
        var startYear = 2025;
        var startMonth = 1;
        ...
        for (var year = startYear; year <= currentYear; year++)
        {
            ...
            for (var month = monthStart; month <= monthEnd; month++)
            {
                ...
                var shortName = new DateTime(year, month, 1).ToString("MMM yyyy");
                var daysInMonth = DateTime.DaysInMonth(year, month);

                // Bill generation is 5th of next month, due date is 20th of next month
    ...
    private async Task SeedMeterReadingsAndBillsAsync()
    {
        ...
        // Get a billing officer for meter readings
        var billingOfficer = await _userManager.FindByEmailAsync("billing@utilitybilling.com");
        ...
        // Create meter readings and bills for November 2025 (overdue bills)
        ...
        // Create meter readings and bills for December 2025
