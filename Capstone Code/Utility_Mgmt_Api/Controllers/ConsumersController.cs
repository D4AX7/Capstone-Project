...
public class ConsumersController : ControllerBase
{
    ...
    /// <summary>
    /// Get All Consumers - Admin (manage users)
    /// </summary>
    [HttpGet]
    ...
    /// <summary>
    /// Get My Profile - Consumer only (view own details)(My Account in consumer nav bar)
    /// </summary>
    [HttpGet("my-profile")]
    ...
    /// <summary>
    /// Update My Profile - Consumer only (update own details)(My Account in consumer nav bar)
    /// </summary>
    [HttpPut("my-profile")]
    [Authorize(Roles = "Consumer")]
